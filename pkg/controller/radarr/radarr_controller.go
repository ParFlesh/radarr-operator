...
import (
	"context"
	"fmt"
	"github.com/parflesh/radarr-operator/defaults"
...
var log = logf.Log.WithName("controller_radarr")

// Add creates a new Radarr Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileRadarr{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	// Create a new controller
	c, err := controller.New("radarr-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}

	// Watch for changes to primary resource Radarr
	err = c.Watch(&source.Kind{Type: &radarrv1alpha1.Radarr{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &radarrv1alpha1.Radarr{},
	})
	if err != nil {
		return err
	}
...
// blank assignment to verify that ReconcileRadarr implements reconcile.Reconciler
var _ reconcile.Reconciler = &ReconcileRadarr{}

// ReconcileRadarr reconciles a Radarr object
type ReconcileRadarr struct {
...
func (r *ReconcileRadarr) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	reqLogger := log.WithValues("Request.Namespace", request.Namespace, "Request.Name", request.Name)
	reqLogger.Info("Reconciling Radarr")

	// Fetch the Radarr instance
	instance := &radarrv1alpha1.Radarr{}
...
func (r *ReconcileRadarr) reconcileSpec(cr *radarrv1alpha1.Radarr) error {
	if cr.Spec.Image == "" {
		cr.Spec.Image = defaults.RadarrImage
...
func (r *ReconcileRadarr) newDeployment(cr *radarrv1alpha1.Radarr) (*appsv1.Deployment, error) {
...
func (r *ReconcileRadarr) newService(cr *radarrv1alpha1.Radarr) (*corev1.Service, error) {
	labels := r.labelsForCR(cr)
...
func (r *ReconcileRadarr) reconcileDeployment(f *appsv1.Deployment, p *appsv1.Deployment) error {
...
func (r *ReconcileRadarr) labelsForCR(cr *radarrv1alpha1.Radarr) map[string]string {
	return map[string]string{
		"radarr": cr.Name,
	}
}

func (r *ReconcileRadarr) parseVolumes(cr []radarrv1alpha1.RadarrSpecVolume) ([]corev1.Volume, []corev1.VolumeMount, error) {
...
func (r *ReconcileRadarr) updateStatus(status radarrv1alpha1.RadarrStatus, cr *radarrv1alpha1.Radarr) error {
...
func (r *ReconcileRadarr) checkDeploymentStatus(dep *appsv1.Deployment) map[appsv1.DeploymentConditionType][]string {
